            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                ...
                <div>
                    ...
                    <label class="relative inline-flex items-center cursor-pointer w-full h-12 px-4 border border-gray-300 rounded-lg hover:border-gray-400 transition-colors bg-white">
                        ...
                        <span class="ml-3 text-sm font-medium text-gray-700 peer-checked:text-blue-700">
            ...
            <div>
                ...
                @if($question->question_image)
                    <div class="mb-4 p-4 bg-indigo-50 rounded-lg border-2 border-indigo-200">
                        <p class="text-sm font-medium text-indigo-800 mb-2 flex items-center">
                        ...
                        <img src="{{ asset('storage/' . $question->question_image) }}" 
                             ...
                             class="max-w-md h-auto rounded-lg border-2 border-indigo-300 shadow-sm">
                ...
                @if($question->explanation_image)
                    <div class="mb-4 p-4 bg-amber-50 rounded-lg border-2 border-amber-200">
                        ...
                        <img src="{{ asset('storage/' . $question->explanation_image) }}" 
                             ...
                             class="max-w-md h-auto rounded-lg border-2 border-amber-300 shadow-sm">
