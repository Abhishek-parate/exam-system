...
<div style="max-width:42rem;">
    ...
    <form method="POST" action="{{ route('admin.subjects.store') }}" class="form-card">
        @csrf
        ...
        <div class="form-group">
            ...
            <textarea name="description" placeholder="Brief description of the subject..." class="form-ctrl">{{ old('description') }}</textarea>
        ...
        <div class="btn-row">
            ...
            <a href="{{ route('admin.subjects.index') }}" class="btn btn-gray">Cancel</a>
        </div>
    </form>
</div>
@endsection