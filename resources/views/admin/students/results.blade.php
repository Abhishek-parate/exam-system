            ...
            <table class="w-full">
                ...
                <tbody class="divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-4 py-3 text-gray-700">
                            @if($attempt->submitted_at || $attempt->auto_submitted_at)
                            {{ ($attempt->submitted_at ?? $attempt->auto_submitted_at)->format('d M Y, h:i A') }}
                            @else
                        ...
                        {{-- 🔥 NEW BUTTON --}}
                        <td class="px-4 py-3">
                            <a href="{{ route('student.exams.attempt.show', [$attempt->exam_id, $attempt->id]) }}"
