...
Route::prefix('admin')->name('admin.')->middleware(['auth', 'role:admin'])->group(function () {
    ...
    Route::get('users/bulk-template', [\App\Http\Controllers\Admin\UserController::class, 'bulkTemplate'])
         ->name('users.bulk-template');

    Route::post('users/bulk-store', [\App\Http\Controllers\Admin\UserController::class, 'bulkStore'])
