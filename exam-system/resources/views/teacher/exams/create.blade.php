...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-6xl mx-auto">
        ...
        <div class="mb-6">
            ...
            <p class="text-gray-600 mt-2">Fill in the details to create a new exam for your students</p>
        </div>
        ...
        <!-- Exam Form -->
        <form action="{{ route('teacher.exams.store') }}" method="POST" id="examForm" class="bg-white shadow-md rounded px-8 pt-6 pb-8">
            @csrf
            ...
            <div class="mb-6">
                ...
                <div class="space-y-2">
                    ...
                    <label class="flex items-center">
                        <input type="checkbox" name="randomize_options" value="1" {{ old('randomize_options') ? 'checked' : '' }}
                            class="mr-2">
                        <span class="text-gray-700">Randomize option order</span>
                    </label>

                    <label class="flex items-center">
                        <input type="checkbox" name="allow_resume" value="1" {{ old('allow_resume') ? 'checked' : '' }}
                            class="mr-2">
                    ...
                    <div class="marking-scheme-item border rounded p-4 mb-4 bg-gray-50">
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div>
                                ...
                                <input type="number" name="marking_schemes[0][correct_marks]" step="0.01" min="0" value="1"
                                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                    required>
                            </div>
                            <div>
                                ...
                                <input type="number" name="marking_schemes[0][wrong_marks]" step="0.01" min="0" value="0.25"
                                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                    required>
                            </div>
                        </div>
            ...
            <div class="mb-6">
                ...
                <div class="border rounded p-4 mb-4 bg-white max-h-96 overflow-y-auto">
                    ...
                    <div id="available-questions" class="space-y-2">
                        @foreach($questions as $question)
                            <div class="question-item p-3 border rounded hover:bg-blue-50 cursor-pointer" 
                                ...
                                <div class="flex justify-between items-start">
                                    ...
                                    <span class="select-indicator text-green-600 hidden">✓ Selected</span>
                                </div>
                            </div>
                        @endforeach
                    </div>
                ...
                <div class="border rounded p-4 bg-blue-50">
                    <h3 class="font-semibold mb-3">Selected Questions: <span id="selected-count">0</span></h3>
